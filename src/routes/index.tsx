			...
			<div className="w-full">
				...
				<div className="p-6">
					<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
						<Link
							to="/characters"
							className="group relative z-10 rounded-xl border border-border p-6 transition-all hover:border-border-hover hover:shadow-lg"
						>
							<div className="flex items-start justify-between">
								...
								<span className="rounded-full bg-accent-muted px-3 py-1 text-sm font-medium text-primary">
									3
								</span>
							</div>
							<div className="absolute inset-x-0 bottom-0 h-1 bg-linear-to-r from-primary-dark/0 via-primary-dark/50 to-primary-dark/0 opacity-0 transition-opacity group-hover:opacity-100"></div>
						</Link>
						<Link
							to="/npcs"
							className="group relative z-10 rounded-xl border border-border p-6 transition-all hover:border-border-hover hover:shadow-lg"
